...
namespace CommonLibrary.CommonModule
{
    ...
    public class PageBase : System.Web.UI.Page
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            try
            {
                ...
                if (IsCheckAuth && !string.IsNullOrWhiteSpace(lo_strCurrMenuLink))
                {
                    ...
                    {
                        lo_bResult = CheckAdminMenu(ref lo_objDB, lo_strCurrMenuLink, out lo_strErrMsg);
                        if (false == lo_bResult)
                        {
                        ...
                        else
                        {
                            ...
                            AdminService lo_objAdminDasServices = new AdminService();
                            ...
                            lo_objAdminDasServices.InsAdminLog(ref lo_objDB, objSes.AdminID, 0, lo_strCurrMenuLink, _pageAccessType.GetHashCode(), 1, lo_strCallParam);
                        }
                    }
                }
            }
        ...
        protected bool CheckAdminMenu(ref ConnectGlobal objDB, string strMenuLink, out string strErrMsg)
        {
            AdminService lo_objAdminDasServices = new AdminService();
            ...
            try
            {
                lo_objResAdminMenuChk = lo_objAdminDasServices.CheckAdminMenu(ref objDB, objSes.AdminID, objSes.GradeCode, strMenuLink);
