    ...
    public partial class AdminMenuRoleUpd : PageBase
    {
        ...
        protected void GetMenuRoleInfo()
        {
            ...
            try
            {
                ...
                lo_objResAdminMenuRoleList = lo_objAdminMenuService.GetAdminMenuRoleList(lo_objReqAdminMenuRoleList);
        ...
        protected void DisplayData()
        {
            ...
            try
            {
                ...
                {
                    MenuRoleNo = hidMenuRoleNo.Value.Equals("") ? 0 : hidMenuRoleNo.Value.ToInt()
                };

                lo_objResAdminMenuRoleDtlList = lo_objAdminMenuService.GetAdminMenuRoleDtlList(lo_objReqAdminMenuRoleDtlList);
