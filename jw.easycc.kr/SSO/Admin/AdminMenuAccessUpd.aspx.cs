    ...
    public partial class AdminMenuAccessUpd : PageBase
    {
        ...
        protected void DisplayData()
        {
            ...
            try
            {
                ...
                lo_objResAdminMenuAccessList = lo_objAdminMenuService.GetAdminMenuAccessList(hidAdminID.Value);
            ...
            try
            {
                lo_objResAdminMenuRoleAccessList = lo_objAdminMenuService.GetAdminMenuRoleAccessList(hidAdminID.Value);
        ...
        protected void OnRowDataBound_AccessList(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                e.Row.Cells[0].Width = Unit.Percentage(40);
