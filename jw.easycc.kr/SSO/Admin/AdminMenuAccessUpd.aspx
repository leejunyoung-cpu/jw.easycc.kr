...
<asp:Content ID="Scriptcontent" ContentPlaceHolderID="headscript" Runat="Server">
    ...
    <style>
        ...
        .tblst1 td {text-align:center;}
        
        .tblst1 td input[type="radio"] {vertical-align:middle;}
        ...
        <div runat="server" id="POPUP_VIEW">
            <div class="popup_control">
                <div class="menu_header">
                    <table id="headtable" class="tblst1">
                        <tr>
                    ...
                    <div style="text-align:center;margin-top:10px;margin-bottom:10px">
                        <ul><li><button type="button" class="btn_b01" id="BtnSaveAll" onclick="javascript:fnSaveAll();"></button></li></ul>
                    </div>
                </div>
                <div id="divAccessList">
                    <asp:GridView ID="repAccessList" runat="server" class="tblst1" AutoGenerateColumns="false" EnableViewState="false" OnRowDataBound="OnRowDataBound_AccessList" DataKeyNames="MenuNo">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <%#Convert.ToInt32(Eval("Depth")).Equals(1) ? "<span style=\"font-weight:bold; font-size:18px;\">"+ Server.HtmlEncode(Eval("MenuName").ToString()) +"</span>" : "<span>- "+Eval("MenuName")+"</span>"%>
                ...
                <div id="divRoleList" style="display:none">
                    <asp:GridView ID="repRoleList" runat="server" class="tblst1" AutoGenerateColumns="false" EnableViewState="false" OnRowDataBound="OnRowDataBound_RoleList" DataKeyNames="MenuRoleNo">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
