            ...
            <div class="popup_control">
                <table id="headtable" class="tblst1">
                    <tr>
                        ...
                        <td><asp:TextBox runat="server" ID="MenuRoleName" Width="100%"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>사용 여부</td>
                ...
                <div style="text-align:center;margin-top:10px;margin-bottom:10px">
                    <ul><li><button type="button" class="btn_b01" onclick="javascript:SaveAll();"><asp:Label runat="server" ID="lblMode" style="color:#fff;font-weight:200;font-size:15px"></asp:Label></button></li></ul>
                </div>

                <asp:GridView ID="repList" runat="server" class="tblst6" AutoGenerateColumns="false" EnableViewState="false" OnRowDataBound="OnRowDataBound" DataKeyNames="MenuNo">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <%#Convert.ToInt32(Eval("Depth")).Equals(1) ? "<span style=\"font-weight:bold\">"+ Server.HtmlEncode(Eval("MenuName").ToString()) +"</span>" : "<span style=\"margin-left:30px\">- "+ Server.HtmlEncode(Eval("MenuName").ToString()) +"</span>"%>
