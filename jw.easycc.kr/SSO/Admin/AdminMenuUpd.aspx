<%@ Page Language="C#" MasterPageFile="~/Popup.Master" AutoEventWireup="true" CodeBehind="AdminMenuUpd.aspx.cs" Inherits="SSO.Admin.AdminMenuUpd" %>
    ...
    <div id="iframe_wrap">
        <div runat="server" id="POPUP_VIEW">
            <div class="popup_control">
                <table id="maintable" class="tblst1">
                    <colgroup>
            ...
            <div style="text-align:center;margin-top:10px">
                <ul><li><button type="button" class="btn_b01" onclick="javascript:fnInsAdminMenu();"><asp:Label runat="server" ID="lblMode" style="color:#fff;font-weight:200;font-size:15px"></asp:Label></button></li></ul>
            </div>
        </div>
    </div>
</asp:Content>
