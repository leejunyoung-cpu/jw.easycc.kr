        ...
        <div class="grid_list">
		 ...
		 <div id="LIST_VIEW">
            ...
            <div class="list_control">
                <table id="maintable" class="tblst0" style="">
                    <colgroup>
                        ...
                        <asp:Repeater ID="repList" runat="server" EnableViewState="false">
                            <ItemTemplate>
                                <tr class="tablelist">
                                    ...
                                    <td><button type="button" class="btn_b01 gray" onclick="javascript:fnDelAdminMenuGroup('<%# Server.HtmlEncode(Eval("MenuGroupNo").ToString())%>','<%# Server.HtmlEncode(Eval("MenuGroupName").ToString())%>');">삭제</button></td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                        <!-- DISPLAY LIST END -->
            ...
            <div style="padding-top:10px;text-align:center">
                <button type="button" class="btn_b01" onclick="javascript:fnddRow('main-tbody');">그룹추가</button>
                <button type="button" class="btn_b01 gray" onclick="javascript:fnUpdAdminMenuGroup();">확인</button>
            </div>
        </div>
        </div>
	</div>
