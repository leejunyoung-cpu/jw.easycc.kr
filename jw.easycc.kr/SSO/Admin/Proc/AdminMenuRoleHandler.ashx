...
/// Description     : 어드민메뉴 역할 관련 Process Handler
/// Special Logic
...
public class AdminMenuRoleHandler : AshxBaseHandler
{
    ...
    protected void GetAdminMenuRoleList()
    {
        ...
        try
        {
            ...
            lo_objResAdminMenuRoleList = objAdminMenuService.GetAdminMenuRoleList(lo_objReqAdminMenuRoleList);
    ...
    protected void GetAdminMenuRoleDelete()
    {
        ...
        try
        {
            ...
            lo_objResInsAdminMenuRole = objAdminMenuService.DelAdminMenuRole(lo_objReqInsAdminMenuRole);
    ...
    protected void GetAdminMenuRoleInsert()
    {
        ...
        try
        {
            lo_objResInsAdminMenuRole = objAdminMenuService.InsRole(strMenuRoleName, strAddMenuList, strAllAuthCode, strRwAuthCode , strRoAuthCode,strUseFlag);
    ...
    protected void GetAdminMenuRoleUpdate()
    {
        ...
        try
        {
            lo_objResAdminMenuRoleUpdate = objAdminMenuService.UpdRole(intMenuRoleNo.ToString(), strMenuRoleName, strAddMenuList, strRmMenuList, strAllAuthCode, strRoAuthCode, strRwAuthCode, strUseFlag);
