...
///
/// Author          : ljy@jwccs.com, 2024-07-05
...
public class AdminMenuHandler : AshxBaseHandler
{
    ...
    protected void GetAdminMenuList()
    {
        ...
        try
        {
            ...
            lo_objResAdminMenuList = objAdminMenuService.GetAdminMenuList(lo_objReqAdminMenuList);
    ...
    protected void GetAdminMenuGroupInfo()
    {
        ...
        try
        {
            ...
            lo_objResAdminMenuGroupList = objAdminMenuService.GetAdminMenuGroupInfo(lo_objReqAdminMenuGroupList);
    ...
    protected void InsAdminMenu()
    {
        ...
        try
        {
            ...
            lo_objResInsAdminMenu = objAdminMenuService.InsAdminMenu(lo_objReqInsAdminMenu);
    ...
    protected void UpdAdminMenu()
    {
        ...
        try
        {
            ...
            lo_objResInsAdminMenu = objAdminMenuService.UpdAdminMenu(lo_objReqInsAdminMenu);
            objResMap.RetCode = lo_objResInsAdminMenu.result.ErrorCode;
            if (objResMap.RetCode.IsFail())
            {
                objResMap.ErrMsg = lo_objResInsAdminMenu.result.ErrorMsg;
    ...
    protected void DelAdminMenu(string lo_strMenuNo)
    {
        ...
        try
        {
            lo_objResDelAdminMenu = objAdminMenuService.DelAdminMenu(lo_strMenuNo);
    ...
    protected int UpMenuList(string lo_strMenuNo, string lo_strMenuSort, string lo_strUseStateCode)
    {
        ...
        try
        {
            ...
            lo_objResUpdAdminMenu = objAdminMenuService.UpdAdminMenu(lo_objReqUpdAdminMenu);
    ...
    protected int UpdMenu(string lo_strMenuGroupNo, string lo_strMenuGroupKind, string lo_strMenuGroupName, string lo_strMenuGroupSort, string lo_strDisplayFlag, string lo_strUseFlag)
    {
        ...
        try
        {
            ...
            lo_objResDelAdminMenuGroup = objAdminMenuService.UpAdminMenuGroup(lo_objReqDelAdminMenuGroup);
    ...
    protected void DelAdminMenuGroup(string lo_strMenuGroupNo)
    {
        ...
        try
        {
            lo_objResInsAdminMenuRole = objAdminMenuService.DelAdminMenuGroup(lo_strMenuGroupNo);
