...
UTILJS.Init =
{
    ...
    ********************************************************************************************/
    fnLoadPageEvent: function () {
        ...
        /**********************************************************************************/
        /*							영문 대문자만 입력 가능한 input						          */
        /*																		          */
        /*사용법 : <input type="text" class="onlyAlphabet"/>--input에 onlyAlphabet 클래스 추가*/
        /*********************************************************************************/
        $(".onlyUppercaseOnly").on('keyup blur', function (event) {
            // 입력된 키가 대문자 알파벳(A-Z)이 아닌 경우 입력을 막음
        ...
        // 소문자가 입력될 경우 대문자로 자동 변환
        $('.onlyUppercaseOnly').on('input', function () {
        ...
        /*		  --input에 onlyAlphabetNum 클래스 추가									*/
        /********************************************************************************/
        $(".onlyUppercaseNum").on('keyup blur', function () {
            if (!(event.keyCode >= 37 && event.keyCode <= 40)) {
                var inputVal = $(this).val();
        ...
        // 소문자가 입력될 경우 대문자로 자동 변환
        $('.onlyUppercaseNum').on('input', function () {
            $(this).val($(this).val().toUpperCase());
        });
